...
import { Share2, CheckCircle, ArrowLeft, Loader2, PieChart } from 'lucide-react';
  ...
  return (
    <div className="max-w-4xl mx-auto pb-20 px-4">
      ...
      <div className="flex justify-center gap-4 mt-16">
        <button className="flex items-center gap-3 px-8 py-4 bg-white text-black rounded-xl font-bold hover:bg-neutral-200 transition-colors shadow-[0_0_20px_-5px_rgba(255,255,255,0.2)]">
          <Share2 className="w-5 h-5" /> Compartir Informe
        </button>
      </div>
    </div>
  );
